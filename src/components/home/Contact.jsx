  ...
  return (
    <section className="py-20">
      <div className="text-center max-w-2xl mx-auto">
        ...
        <p className="text-primary text-[15px] md:text-[18px] font-secondary leading-relaxed mb-8 mt-4">
      ...
      <div className="min-h-screen flex items-center justify-center lg:px-4 px-2 ">
        <div className="max-w-6xl w-full flex flex-col md:flex-row gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-semibold mb-4 font-primary text-secondary">
              Let’s Talk !
            </h2>

            <p className="text-secondary mb-8 font-secondary">
